    ...
    <body>
        ...
        <section class="limit cms__bg">
            <div class="cms__botones">
                <?php
                    $sql = sprintf('SELECT * FROM registros where programa="Programa para Jóvenes y Adultos"');
                    $r = $cnx->query($sql);
                    $cr = $r->num_rows;
                ?>
                <div class="cms__nav__enlace cms__nav__enlace--numero" href="#"><?php echo $cr; ?> REGISTROS</div>
            ...
            <table>
                ...
                <?php
                    $sql = sprintf('SELECT * FROM registros where formulario = "adultos" ORDER BY fecha DESC');
                    $r = $cnx->query($sql);
                    if($r->num_rows>0) {
