...
header("Content-Disposition: attachment; filename=registros-adultos.xls");
header("Pragma: no-cache");
header ("Expires: 0");

$cnx = new mysqli('localhost', 'icpna', '874oRRQRtmN#','icpna');
$cnx->set_charset("utf8");
//$sql = 'SELECT * FROM registros WHERE formulario="adultos" ORDER BY fecha DESC';
$sql = 'SELECT * FROM registros WHERE programa="Programa para Jóvenes y Adultos" ORDER BY fecha DESC';
